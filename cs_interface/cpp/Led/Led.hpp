...
class LED{
	...
	int send_strip(const std::string &name);
	int send_all_color(PIXEL &color);
	int send_all_color(const std::string &color);
	int send_strip_color(PIXEL &color, uint8_t strip);
	int send_strip_color(const std::string &color, uint8_t strip);
	...
	int send_dual_color(const std::string &primary_color, const std::string &secondary_color);
	int send_dual_strip(PIXEL &primary_color, PIXEL &secondary_color, uint8_t strip);
	int send_dual_strip(const std::string primary_color, const std::string secondary_color, uint8_t strip);
	int send_refresh();
